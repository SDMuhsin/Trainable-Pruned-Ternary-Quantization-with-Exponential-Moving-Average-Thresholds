...
#SBATCH --output=kmnist-experimental-%N-%j.out
...
python3 src/Experiments/experiment_pTTQ_experimental.py --parameters_file=./parameters_files/KMNIST/kmnist_experimental.json
