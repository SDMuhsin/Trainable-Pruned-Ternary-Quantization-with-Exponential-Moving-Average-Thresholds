...
sbatch \
	...
	--output=emnist-exp3-experimental-%N-%j.out \
	--wrap="
	    ...
	    python3 src/Experiments/experiment_pTTQ_experimental.py --parameters_file=./parameters_files/EMNIST/emnist_exp3_experimental.json
	"
