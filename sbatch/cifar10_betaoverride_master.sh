...
echo "Beginning beta override sbatch scripts for CIFAR10"
...
do
    ...
    sbatch \
        ...
        --output=cifar10-beta${beta}-%N-%j.out \
        --wrap="
            ...
            python3 src/Experiments/experiment_pTTQ_experimental.py --parameters_file=./parameters_files/CIFAR10/cifar10_experimental.json --k_override=1.0 --beta=$beta
        "
done
