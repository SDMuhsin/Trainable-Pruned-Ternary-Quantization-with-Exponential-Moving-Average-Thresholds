...
sbatch \
	...
	--output=mnist-exp3-experimental-%N-%j.out \
	--wrap="
	    ...
	    python3 src/Experiments/experiment_pTTQ_experimental.py --parameters_file=./parameters_files/MNIST/mnist_exp3_experimental.json
	"
