...
echo "Beginning k override sbatch scripts for EMNIST"
...
do
    ...
    sbatch \
        ...
        --wrap="
            ...
            python3 src/Experiments/experiment_pTTQ_experimental.py --parameters_file=./parameters_files/EMNIST/emnist_experimental.json --k_override=$k
        "
done
