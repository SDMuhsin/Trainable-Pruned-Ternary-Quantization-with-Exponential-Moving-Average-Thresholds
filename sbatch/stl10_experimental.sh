...
#SBATCH --output=stl10-experimental-%N-%j.out
...
python3 src/Experiments/experiment_pTTQ_experimental.py --parameters_file=./parameters_files/STL10/stl10_experimental.json
