...
#SBATCH --output=mnist-experimental-%N-%j.out
...
python3 src/Experiments/experiment_pTTQ_experimental.py --parameters_file=./parameters_files/MNIST/mnist_experimental.json
