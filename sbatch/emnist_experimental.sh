...
#SBATCH --output=emnist-experimental-%N-%j.out
...
python3 src/Experiments/experiment_pTTQ_experimental.py --parameters_file=./parameters_files/EMNIST/emnist_experimental.json
