...
from src.utils.model_compression import approx_weights, approx_weights_fc, pruning_function_pTTQ, pruning_function_asymmetric_manessi,pruning_function_pTTQ_experimental,pruning_function_pTTQ_experimental_learned, pruning_function_pTTQ_experimental_track
...
class Experiment(ExperimentTTQ):
    def __init__(self, parameters_exp):
        ...
        if (self.pruning_function_type.lower() == 'manessi_asymmetric_pttq'):
            ...
            self.pruning_function = pruning_function_pTTQ_experimental_track
    ...
    def save_thresholds(self):
        ...
        np.save('./results/track_thresholds_experimental.npy', data)
    ...
    def quantize(self, kernel, w_p, w_n):
        ...
        pruned_kernel, delta_min, delta_max = self.pruning_function(kernel, self.alpha, self.a, self.b,self.k)
