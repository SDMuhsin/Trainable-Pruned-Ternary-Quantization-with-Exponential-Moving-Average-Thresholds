    ...
    def countNonZeroWeights(self, model, quantizedLayers=False):
        ...
        for name, param in model.named_parameters():
            if (not self.countNonZeroParamsQuantizedLayers):
                ...
                # More general method
                if (self.model_to_use.lower() in ['mnistvitcnn','mnist2dcnn','kmnistresnet18','fmnistresnet18','svhnresnet18','emnistresnet18','cifar10resnet50','cifar100resnet50','stl10resnet50','mnistvit','fmnistenet','kmnistdensenet','fmnistinceptionv4','tinyimagenetresnet50','tinyimagenetconvnext'])\
